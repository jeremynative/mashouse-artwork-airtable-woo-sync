...
HTML;
    ...
    private static function print_catalog_css(): void {
        ...
        echo '<style>
            ...
            @media(max-width:1024px){.ma-custom-store-grid{padding-top:0!important}.ma-store-toolbar{position:static;grid-template-columns:1fr;width:100%;transform:none}.ma-store-count{text-align:left}.ma-custom-store-grid__items{columns:2 240px!important}.ma-shop-on-view__grid,.woocommerce ul.products.ma-shop-catalog-grid{grid-template-columns:repeat(2,minmax(0,1fr))!important;column-gap:26px!important;row-gap:44px!important}}
