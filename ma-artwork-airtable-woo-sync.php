...
final class MA_Artwork_Airtable_Woo_Sync {
    ...
    public static function render_donate_menu_button_css(): void {
        ...
        echo '<style id="ma-menu-single-line-fix" data-no-optimize="1" data-cfasync="false">@media(min-width:961px){body .builder-item--primary-menu .nav-ul>li{flex:0 0 auto!important}body .builder-item--primary-menu .nav-ul>li>.wrap{flex:0 0 auto!important;flex-wrap:nowrap!important;white-space:nowrap!important}body .builder-item--primary-menu .nav-ul>li>.wrap>a{flex:0 0 auto!important;white-space:nowrap!important}}@media(max-width:1700px) and (min-width:961px){body .builder-item--header_search .component-wrap.search-field,body .builder-item--header_search .widget-search,body .builder-item--header_search .search-form{width:230px!important;max-width:230px!important}body .builder-item--primary-menu .nav-ul>li>.wrap>a:not(.ma-givebutter-donate-link){padding-left:7px!important;padding-right:7px!important;font-size:14px!important}.ma-givebutter-donate-link{padding:7px 10px!important;font-size:14px!important}}@media(max-width:1500px) and (min-width:1301px){body .builder-item--header_search .component-wrap.search-field,body .builder-item--header_search .widget-search,body .builder-item--header_search .search-form{width:160px!important;max-width:160px!important}}@media(max-width:1300px) and (min-width:961px){body .builder-item--header_search{display:none!important}body .builder-item--primary-menu .nav-ul>li>.wrap>a:not(.ma-givebutter-donate-link){padding-left:4px!important;padding-right:4px!important;font-size:13px!important}.ma-givebutter-donate-link{padding:7px 8px!important;font-size:13px!important}}</style>';
    }
    ...
    public static function visitor_checkin_shortcode(): string {
        ...
        <section class="ma-visitor-checkin" aria-labelledby="ma-visitor-checkin-title">
            ...
            <form class="ma-visitor-checkin__form" action="<?php echo esc_url(admin_url('admin-post.php')); ?>" method="post">
                ...
                <p class="ma-visitor-checkin__honeypot" aria-hidden="true"><label for="ma-visitor-website">Website</label><input id="ma-visitor-website" name="website" type="text" tabindex="-1" autocomplete="off"></p>
    ...
    public static function handle_visitor_checkin(): void {
        ...
        if (sanitize_text_field(wp_unslash($_POST['website'] ?? '')) !== '') {
...
body.home #ma-library-home-carousel{box-sizing:border-box!important;min-width:0!important;padding-left:24px!important;padding-right:24px!important;width:100%!important}
body.home #ma-library-home-carousel .ma-library-home-carousel__inner{box-sizing:border-box!important;margin-left:auto!important;margin-right:auto!important;max-width:1220px!important;min-width:0!important;width:100%!important}
body.home #ma-library-home-carousel .ma-library-home-carousel__stage,
body.home #ma-library-home-carousel .ma-library-home-carousel__track{box-sizing:border-box!important;min-width:0!important;width:100%!important}
...
body.home .give-donor-wall-shortcode-wrap .give-grid{display:block!important;column-count:3!important;column-gap:18px!important}
...
body.home #ma-library-home-carousel{padding-left:24px!important;padding-right:24px!important}
}
...
body.home .give-donor-wall-shortcode-wrap .give-grid{column-count:1!important}
...
HTML;
    ...
    public static function render_artist_profile_css(): void {
        ...
        if ($is_artist_post) {
            ...
            echo '<style id="ma-artist-page-programs-css">.ma-artist-page__programs{max-width:860px;margin:38px 0;padding-top:28px;border-top:1px solid rgba(0,0,0,.14)}.ma-artist-page__programs h2{margin:0 0 18px!important;color:#111!important;font-size:22px!important;line-height:1.2!important;font-weight:650!important}.ma-artist-page__relationship-grid{display:grid;grid-template-columns:repeat(2,minmax(0,1fr));gap:26px}.ma-artist-page__relationship-card{display:block;color:#111!important;text-decoration:none!important}.ma-artist-page__relationship-image{aspect-ratio:1/1;overflow:hidden;background:#f4f2ee}.ma-artist-page__relationship-image img{display:block;width:100%;height:100%;object-fit:contain}.ma-artist-page__relationship-body{padding:12px 0 0}.ma-artist-page__relationship-status{margin:0 0 7px!important;color:#8f1c16!important;font-size:11px!important;font-weight:750!important;letter-spacing:.08em!important;line-height:1.2!important;text-transform:uppercase}.ma-artist-page__relationship-body h3{margin:0 0 7px!important;color:#111!important;font-size:17px!important;line-height:1.28!important;font-weight:700!important}.ma-artist-page__relationship-body>p:last-child{margin:0!important;color:#555!important;font-size:13px!important;line-height:1.4!important}.ma-artist-page__relationship-card:hover h3{text-decoration:underline!important;text-underline-offset:3px}@media(max-width:640px){.ma-artist-page__relationship-grid{grid-template-columns:1fr;gap:24px}.ma-artist-page__relationship-card{max-width:420px}}</style>';
        }
        ...
        (function(){
            ...
            function decorate(){
                ...
                document.querySelectorAll('ul.products').forEach(function(list){
                    if (list.closest('.ma-custom-store-grid')) return;
                    list.classList.add('ma-hide-elementor-products');
    ...
    private static function print_catalog_css(): void {
        ...
        echo '<style>
            ...
            .woocommerce ul.products.ma-hide-elementor-products,
            .woocommerce ul.products.ma-hide-elementor-products.ma-shop-catalog-grid,
            ul.products.ma-hide-elementor-products,
            ul.products.ma-hide-elementor-products.ma-shop-catalog-grid{display:none!important;height:0!important;min-height:0!important;margin:0!important;padding:0!important;overflow:hidden!important}
            ...
            @media(max-width:1024px){body.post-type-archive-product .neve-main{padding-top:12px!important}body.post-type-archive-product .elementor-location-archive{padding-top:0!important}body.post-type-archive-product .elementor-element-1e95a2b9{padding-top:12px!important}.ma-custom-store-grid{padding-top:0!important}.ma-store-toolbar{position:static;grid-template-columns:1fr;width:100%;transform:none}.ma-store-count{text-align:left}.ma-custom-store-grid__items{columns:2 240px!important}.ma-shop-on-view__grid,.woocommerce ul.products.ma-shop-catalog-grid{grid-template-columns:repeat(2,minmax(0,1fr))!important;column-gap:26px!important;row-gap:44px!important}}
