...
final class MA_Artwork_Airtable_Woo_Sync {
    ...
    public static function render_donate_menu_button_css(): void {
        ...
        echo '<style id="ma-menu-single-line-fix" data-no-optimize="1" data-cfasync="false">@media(min-width:961px){body .builder-item--primary-menu .nav-ul>li{flex:0 0 auto!important}body .builder-item--primary-menu .nav-ul>li>a{flex:0 0 auto!important;white-space:nowrap!important}}@media(max-width:1700px) and (min-width:961px){body .builder-item--header_search .component-wrap.search-field,body .builder-item--header_search .widget-search,body .builder-item--header_search .search-form{width:230px!important;max-width:230px!important}body .builder-item--primary-menu .nav-ul>li>a:not(.ma-givebutter-donate-link){padding-left:7px!important;padding-right:7px!important;font-size:14px!important}.ma-givebutter-donate-link{padding:7px 10px!important;font-size:14px!important}}</style>';
    }
